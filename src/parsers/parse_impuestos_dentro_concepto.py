from models.comprobante import ImpuestosDentroConcepto
from parsers.parse_traslados import parse_traslados
from parsers.parse_retenciones import parse_retenciones


def parse_impuestos_dentro_concepto(impuestos_element, namespaces):
    impuestos = ImpuestosDentroConcepto()
